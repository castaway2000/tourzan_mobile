    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.title_description_view}>
          ...
          <Text style={styles.title_description_text}>
            Hey! You have received new time limit offer. Please respond to this
            offer.
          </Text>
        </View>
            ...
            <View style={styles.user_info_view}>
              ...
              <View style={styles.info_view}>
                ...
                <Text style={styles.description_text}>
                  Conventry City Guide Including Conventry Hotels
                </Text>
              </View>
              <TouchableOpacity
                onPress={() => this.onChat()}
              ...
              >
                <Image
                  resizeMode="contain"
                  source={require("../assets/images/chat_blue.png")}
