  ...
  onDone() {
    ...
    if (
      (this.state.passwordNew.length < 8 ||
        this.state.passwordNew.length > 20) &&
      (this.state.passwordConfirm.length < 8 ||
        this.state.passwordConfirm.length > 20)
    ) {
      Alert.alert(
        "Tourzan",
        "Password must be minimum 8 and maximum 20 character long.",
        [{ text: "OK", onPress: () => {} }],
        { cancelable: false }
      );
      return;
      ...
      <View style={styles.container}>
        ...
        <View style={styles.main_view}>
          ...
          <View style={styles.row_icon_view}>
            <Image
              resizeMode="contain"
              source={require("../assets/images/key_unlock_icon.png")}
