...
class WriteFeedbackScreen extends React.Component {
    ...
    _showRatingViewMain = () => {
        ...
        let rating = isGuide ? profileData.guide_data.guide_rating : profileData.tourist_rating
            ...
            <View style={styles.container}>
                ...
                <ScrollView style={styles.scrollview_container}>
                    <View style={styles.content_container}>
                        <View style={styles.main_container}>
                            ...
                            <View style={styles.overview_view}>
                                <Text style={styles.overview_title_text}>Let us know how it went</Text>
                    ...
                    <TextInput
                        ...
                        style={[styles.text_input, { height: Math.max(35, this.state.height) }]}
