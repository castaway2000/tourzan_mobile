...
class GuideItemDetailScreen extends React.Component {
    ...
    componentDidMount(){
        ...
        this.setState({
            dataSource:this.state.dataSource.cloneWithRows(params.guideData.guide_services),
        })
    }
    ...
    _interestingBtnHandlePress() {
     ...
     showInterest(){
         var {params} = this.props.navigation.state
         return(
             params.guideData.interests.map((item, index) => {
                 return(
                     <View style = {styles.interestItemView} key = {index}>
                         <Text style = {styles.interesting_title_text}>{item.interest.name}</Text>
                     </View>
                 )
             })
         )
  ...
  render() {
      ...
      return (
        <View style={styles.container}>  
            ...
            <ScrollView style={styles.scrollview_container}>
                <View style={styles.main_container}>
                    ...
                    <View style={styles.overview_view}>
                        ...
                        <ReadMore
                            ...
                            <Text style={styles.overview_content_text}>{params.guideData.overview}</Text>
                        </ReadMore>
                    </View>
                    <View style={styles.interesting_view}>
                        <View style={styles.devide_view}/>
                        <Text style={[styles.interesting_title_text, {marginTop: 10}]}>Interest</Text>
                ...
                <View style={styles.listview_view}>
                    <View style={styles.listview_title_view} pointerEvents='none'>
                        <Text style={styles.listview_title_text}> {params.guideData.guide_services.length} REVIEWS </Text>
                        {/*<Rating ratingCount={5} imageSize={15}  onFinishRating={this.ratingCompleted}/>*/}
                    </View>
                    <ListView
            ...
            <Image resizeMode='cover' source = {{uri: params.guideData.profile_image}} style={styles.avatar_icon} defaultSource = {require("../../assets/images/user_placeholder.png")}/> 
