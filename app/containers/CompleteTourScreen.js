...
class CompleteTourScreen extends React.Component {
    ...
    onWriteReviewBtnClick() {
        ...
        this.props.navigation.navigate('WriteFeedback', { profileData: this.state.profileData, ratings: this.state.ratings, tripData: tripData })
    }
    ...
    _showProfilePicture = () => {
        ...
        if (profilepicture) {
            return (
                <Image resizeMode='cover' source={{ uri: profilepicture }} style={styles.avatar_img} />
            )
        } else {
            return (
                <Image resizeMode='cover' source={require("../assets/images/defaultavatar.png")} style={styles.avatar_img} />
                    ...
                    <View style={styles.scroll_content_view}>
                            ...
                            <View style={styles.row}>
                                ...
                                <View style={styles.info_view}>
                                    ...
                                    <View style={styles.location_view}>
                                        ...
                                        <Text style={styles.location_text}>440 Curtola, CA (Pending)</Text>
                                    </View>
                                </View>
                        ...
                        <View style={styles.tour_detail_view}>
                            ...
                            <View style={styles.row_setting_btn_view}>
                                ...
                                <Text style={styles.row_setting_btn_text}>053 Maggio Road Apt. 016(Pending)</Text>
                            </View>
                            <View style={styles.row_setting_btn_view}>
                                <Image resizeMode='contain' source={require("../assets/images/time_icon_black.png")} style={styles.row_setting_btn_icon} />
                                <Text style={styles.row_setting_btn_text}>06 Hours 20 Minutes(Pending)</Text>
                            </View>
                            <View style={styles.row_setting_btn_view}>
