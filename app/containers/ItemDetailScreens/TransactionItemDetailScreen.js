...
class TransactionItemDetailScreen extends React.Component {
    ...
    getTripDurationString = (seconds) => {
        ...
        if (seconds < 60) {
            ...
            formatted = moment.utc(seconds * 1000).format('HH') + 'h ' + moment.utc(seconds * 1000).format('mm') + 'm';
        }
    ...
    render() {
        ...
        if (tripData.reviews) {
            tripData.reviews.user_guide.guide_rating = tripData.reviews.guide_rating ? tripData.reviews.guide_rating : '0'
            tripData.reviews.user_guide.guide_feedback_text = tripData.reviews.guide_feedback_text ? tripData.reviews.guide_feedback_text : ''
            tripData.reviews.user_guide.fees_total = tripData.fees_total ? tripData.fees_total : 'Not available'
        }
                    ...
                    <View style={styles.info_main_view}>
                        ...
                        <View style={styles.date_time_view}>
                            <View style={styles.info_icon_row_view}>
                                <Image resizeMode='contain' source={require("../../assets/images/calendar_icon.png")} style={styles.small_info_icon} />
                                <Text style={styles.info_icon_row_lb}>{this.getDateString(tripData.date_booked_for)}</Text>
                            </View>
                            <View style={styles.info_icon_row_view_right}>
                                <Image resizeMode='contain' source={require("../../assets/images/time_icon_black.png")} style={styles.small_info_icon} />
                                <Text style={styles.info_icon_row_lb}>{this.getTripDurationString(tripData.duration_seconds)}</Text>
                            </View>
                        </View>
                            ...
                            <View style={styles.personal_info_view}>
                                ...
                                <View style={styles.info_view}>
                                    ...
                                    <View style={styles.location_view}>
                                        ...
                                        <Text style={styles.location_text}>{tripData.reviews.user_guide.guide_rating.username}</Text>
                                    </View>
                                    <Text style={styles.description_text}>Conventry City Guide...</Text>
                                </View>
