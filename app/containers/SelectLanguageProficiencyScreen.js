...
class SelectLanguageProficiencyScreen extends React.Component {
    ...
    proficiencyDidSelected(proficiency) {
        ...
        this.props.navigation.state.params.languageDidSelected(this.props.navigation.state.params.selectedLanguage)
                        ...
                        {this.state.proficiencys.length > 0 &&
                            <FlatList
                                ...
                                renderItem={({ item, index }) => (
                                    <TouchableOpacity onPress={() => this.proficiencyDidSelected(item)}>
