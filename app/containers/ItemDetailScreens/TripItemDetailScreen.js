        ...
        <ParallaxScrollView
          ...
          renderBackground={() => (
            <View key="background">
              <Image
                resizeMode="cover"
                source={{ uri: params.tourData.image_small }}
          ...
          renderForeground={() => (
            <View key="parallax-header">
              <View style={styles.top_location_view}>
                <Image
                  resizeMode="contain"
                  source={require("../../assets/images/location_white_icon.png")}
                  style={styles.top_location_icon}
                />
                <Text style={styles.top_location_lb}>
                  {params.tourData.name}
                </Text>
              </View>
            </View>
          )}
            ...
            <View style={styles.bottom_container}>
              ...
              <View style={styles.info_row_view}>
                ...
                <View style={styles.info_icon_row_view}>
                  ...
                  />
                  <Text style={styles.info_icon_row_lb}>
                    ${params.tourData.price}
                  </Text>
                </View>
              </View>
              <View style={styles.map_view}>
                <Image
                  source={require("../../assets/images/ic_googlemap.jpg")}
