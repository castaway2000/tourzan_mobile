                ...
                <View style={styles.row}>
                    ...
                    <View style={styles.info_view}>
                        ...
                        <View style={styles.info_row_view}>
                            ...
                            <Text style={styles.time_text}>{this.getTripDurationString(rowData.duration_seconds)}</Text>
                        </View>
                    </View>
                    <View style={styles.row_right_view}>
                        <Text style={styles.right_text}>{this.getDateString(rowData.date_booked_for)}</Text>
