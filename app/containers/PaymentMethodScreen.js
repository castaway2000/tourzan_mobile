...
class PaymentMethodScreen extends React.Component {
  ...
  onVisaClick() {
    this.setState(previousState => {
      return {
        visaSelcted: !previousState.visaSelcted,
        mastercardSelected: false,
        expressSelected: false
      };
    });
  ...
  onMastercardClick() {
    this.setState(previousState => {
      return {
        mastercardSelected: !previousState.mastercardSelected,
        visaSelcted: false,
        expressSelected: false
      };
    });
  ...
  onExpressClick() {
    this.setState(previousState => {
      return {
        expressSelected: !previousState.expressSelected,
        mastercardSelected: false,
        visaSelcted: false
      };
    });
            ...
            <View style={styles.card_list_view}>
              {this.state.visaSelcted ? (
                <TouchableOpacity
                  ...
                  onPress={() => this.onVisaClick()}
                >
                  <IconBadge
                    MainElement={
                      <Image
                        resizeMode="contain"
                        source={require("../assets/images/visa-pay-logo_checked.png")}
              ...
              {this.state.mastercardSelected ? (
                <TouchableOpacity
                  style={styles.card_image_view}
                  onPress={() => this.onMastercardClick()}
                >
                  <IconBadge
                    MainElement={
                      <Image
                        resizeMode="contain"
                        source={require("../assets/images/mastercard_checked.png")}
                        style={styles.card_image}
                      />
                    }
                    BadgeElement={
              ...
              {this.state.expressSelected ? (
                <TouchableOpacity
                  style={styles.card_image_view}
                  onPress={() => this.onExpressClick()}
                >
                  <IconBadge
                    MainElement={
                      <Image
                        resizeMode="contain"
                        source={require("../assets/images/american-express-logo_checked.png")}
                        style={styles.card_image}
                      />
                    }
                    BadgeElement={
          ...
          <View style={styles.form_view}>
            ...
            <View style={styles.card_number_view}>
              <TextInput
                ...
                style={styles.inputText_number}
                underlineColorAndroid={"gray"}
              />
              <Image
                resizeMode="contain"
                source={require("../assets/images/card_number_icon.png")}
                style={styles.card_number_icon}
              />
            </View>
            <View style={styles.card_number_view}>
              <TextInput
                placeholder="Expire Date"
                style={styles.inputText_expire_date}
                underlineColorAndroid={"gray"}
              />
              <TextInput
                placeholder="CVV/CVC"
                secureTextEntry={true}
                style={styles.inputText_cvv}
                underlineColorAndroid={"gray"}
              />
            </View>
            <View style={styles.encrypt_view}>
              <Image
                resizeMode="contain"
                source={require("../assets/images/key_lock_icon.png")}
                style={styles.key_lock_icon}
              />
              <Text style={styles.encrypt_text}>
